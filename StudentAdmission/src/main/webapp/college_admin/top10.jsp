...
<%@page import="com.jntu.beans.Selected_students"%>
...
<body>
	<%
		if (request.getAttribute("details") != null) {
			...
			List<Selected_students> list = (List<Selected_students>) request.getAttribute("details");
			Iterator<Selected_students> list1 = list.iterator();
			out.print("<table>");
